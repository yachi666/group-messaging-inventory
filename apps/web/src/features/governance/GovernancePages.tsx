...
export function UseCasesPage({ initialId, onNavigate }: { initialId?: string; onNavigate: Navigate }) {
  ...
  if (selected) return <UseCaseDetail coverageFlow={inventory?.coverageFlow ?? []} governanceEvents={inventory?.governanceEvents ?? []} governanceTemplates={governanceTemplates} governanceUseCases={governanceUseCases} useCase={selected} onBack={() => onNavigate('use-cases')} onNavigate={onNavigate} />;
...
export function TemplatesPage({ initialId, onNavigate }: { initialId?: string; onNavigate: Navigate }) {
  ...
  if (selected) return <TemplateDetail coverageFlow={inventory?.coverageFlow ?? []} governanceEvents={inventory?.governanceEvents ?? []} governanceUseCases={governanceUseCases} template={selected} onBack={() => onNavigate('templates')} onNavigate={onNavigate} />;
