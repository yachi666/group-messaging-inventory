...
export const initialAnalysisResults = [
  {
    ...
    anomalies: ['Unusual formatting', 'New payee pattern'],
    owner: 'A. Morgan',
...
export const fallbackLatestAnalysisEvaluation = {
  ...
  evaluation: {
    ...
    thresholds: {
      ...
      minPlaceholderRecall: 0.9,
    },
    failedCaseIds: [],
  },
  release: {
    releaseId: 'REL-20260628-local',
    status: 'ReadyForPromotion',
    promotionAllowed: true,
    evidenceHash: 'sha256:local-replay-evidence',
    pipeline: {
      pipelineVersion: 'template-analysis-harness@0.1.0',
      promptVersion: 'template-analysis-prompt@2026-06',
      modelProvider: 'noop',
      modelName: 'deterministic-local-adapter',
      rulesetVersion: 'routing-rules@2026-06',
    },
  },
} as const satisfies LatestAnalysisEvaluation;
